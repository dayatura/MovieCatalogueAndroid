...
public class SearchFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final String movieType = getArguments().getInt("currFragment") == R.id.navigation_movies ? "movie" :
                getArguments().getInt("currFragment") == R.id.navigation_tv_shows ? "tv" : "movie";
        ...
        movieViewModel.searchMovies(movieType, getArguments().getString("query"));
        showLoading(true);
